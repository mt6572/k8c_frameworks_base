...
public class PowerProfile {
   ...
   /**
     * Power consumed while browsing on wifi
     */
    public static final String POWER_WIFI_BROWSE_ACTIVE = "wifi.browse.active";

    /**
     * Power consumed while playing music on bluetooth headset
     */
    public static final String POWER_BLUETOOTH_A2DP_ACTIVE = "bluetooth.a2dp.active";

    /**
     * Power consumed on different screen brightness levels
     */
    public static final String POWER_SCREEN_BRIGHTNESS = "screen.brightness";

    /**
     * Power consumed while connected on 3G network
     */
    public static final String POWER_RADIO_3G_ON = "radio.3g.on";

    /**
     * Power consumed while talking on 3G
     */
    public static final String POWER_RADIO3G_ACTIVE = "radio.3g.active";

    /**
     * Power consumed while browsing on 3G mobile data
     */
    public static final String POWER_RADIO_3G_DATA = "radio.3g.data";

    /**
     * Power consumed while using speaker as audio output
     */
    public static final String POWER_AUDIO_SPEAKER = "audio.speaker";
