...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
			...
			loadBooleanSetting(stmt, Settings.System.IPO_NEED_FIRST_SETTING,
                    R.bool.def_ipo_need_first_setting); //add fuhaifa20131106 for IpoSetting
...
//heyong
           ...
           // }
            ...
            //Settings.Secure.putString(mContext.getContentResolver(), Settings.Secure.LOCATION_PROVIDERS_ALLOWED, "gps,network");
