...
public final class QuickSettingsConnectionModel {
        ...
        if (FeatureOption.MTK_WLAN_SUPPORT) {
            mWifiTileView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                       if(SystemProperties.get("persist.service.powersaving").equals("1"))
        	      {
		       Toast.makeText(mContext, R.string.power_saving_mode, Toast.LENGTH_LONG).show();
    ...
    private final class WifiStateTracker extends StateTracker {
		...
		//if(SystemProperties.get("persist.service.powersaving").equals("1"))
        	//{
		//Toast.makeText(mContext, "Power saving mode", Toast.LENGTH_LONG).show();
			 // buttonView.setChecked(false);
		//return false;
        	//}
