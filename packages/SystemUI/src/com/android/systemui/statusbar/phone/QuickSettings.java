...
class QuickSettings {
    ...
    private void addUserTiles(ViewGroup parent, LayoutInflater inflater) {
		...
		//userTile.setVisibility(View.GONE); //fuhaifa
    ...
    private void addTemporaryTiles(final ViewGroup parent, final LayoutInflater inflater) {
		...
		//alarmTile.setVisibility(View.GONE); //fuhaifa
        ...
        if (FeatureOption.MTK_WFD_SUPPORT) {
			...
			//remoteDisplayTile.setVisibility(View.GONE); //fuhaifa
        }
        ...
        if (SHOW_IME_TILE || QuickSettingsTileView.DEBUG_GONE_TILES) {
			...
			//imeTile.setVisibility(View.GONE); //fuhaifa
        }
		...
		//bugreportTile.setVisibility(View.GONE); //fuhaifa
        /*
        ...
        */
		...
		//sslCaCertWarningTile.setVisibility(View.GONE); //fuhaifa
    }
    ...
    private void addSettingTile(ViewGroup parent, LayoutInflater inflater) {
        ...
        settingsTile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startSettingsActivity(android.provider.Settings.ACTION_SETTINGS);//startSettingsActivity(/*android.provider.Settings.ACTION_SETTINGS*/"android.provider.Settings.ACTION_SETTINGS");
            }
        });
        mModel.addSettingsTile(settingsTile,
                new QuickSettingsModel.BasicRefreshCallback(settingsTile));
        //parent.addView(settingsTile);
		//settingsTile.setVisibility(View.GONE); //fuhaifa
    }
    ...
    private void addDataConnectionTile(ViewGroup parent, LayoutInflater inflater) {
		...
		//dataConnectionTile.setVisibility(View.GONE); //fuhaifa
    ...
    private void addDataUsageTile(ViewGroup parent, LayoutInflater inflater) {
		...
		//datausageTile.setVisibility(View.GONE); //fuhaifa
    ...
    private void addAudioProfileTile(ViewGroup parent, LayoutInflater inflater) {
		...
		//audioProfileTile.setVisibility(View.GONE); //fuhaifa
    ...
    private void addBatteryTile(ViewGroup parent, LayoutInflater inflater) {
		...
		//batteryTile.setVisibility(View.GONE); //fuhaifa
