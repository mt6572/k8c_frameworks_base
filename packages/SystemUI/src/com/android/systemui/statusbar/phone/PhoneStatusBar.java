...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode {
			...
			if (action.equals(Intent.ACTION_CHANGE_STATUSBAR_BG)) {
				...
				//StatusBarBg_Flag=true;
				 if(StatusBarBg_Flag ){
					...
					mStatusBarView.setBackgroundResource(R.drawable.system_bar_background);//blank	 status_bar_background	status_bar_bg_tile
					mStatusBarView.invalidate();
				 }
				}		
			}
        ...
        public void onClick(View v) {
            if (mHasSettingsPanel) {
                ...
                startActivityDismissingKeyguard(
                       new Intent(android.provider.Settings.ACTION_SETTINGS), true);// new Intent(/*android.provider.Settings.ACTION_SETTINGS*/"android.settings.NEWSETTINGS"), true);
            }
        }
    };
    ...
    private View.OnClickListener mHeaderSettingsButtonListener = new View.OnClickListener() {
        public void onClick(View v) {
              //  startActivityDismissingKeyguard(new Intent("android.settings.NEWSETTINGS"), true);//daizhx modified
               startActivityDismissingKeyguard(new Intent(android.provider.Settings.ACTION_SETTINGS), true);//daizhx modified
        }
    };
    /// M: [SystemUI] Remove settings button to notification header @}.
...
toast.setView(View.inflate(mContext, R.layout.application_guide, null));
