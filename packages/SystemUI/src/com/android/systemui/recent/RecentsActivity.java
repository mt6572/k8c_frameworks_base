...
public class RecentsActivity extends Activity {
    ...
    public void onStop() {
        ...
        if (mRecentsPanel != null) {
            ...
            mRecentsPanel.mHandler.removeMessages(mRecentsPanel.UPDATE_MEMORRY_INFO);//lava add by liuweibo 20140328
        }
        super.onStop();
    }
    ...
    public void onStart() {
        ...
        if (mRecentsPanel != null) {
            ...
            mRecentsPanel.mHandler.sendEmptyMessage(mRecentsPanel.UPDATE_MEMORRY_INFO);//lava add by liuweibo 20140328
        }
        super.onStart();
    }
