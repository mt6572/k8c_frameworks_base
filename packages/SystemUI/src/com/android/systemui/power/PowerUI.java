...
public class PowerUI extends SystemUI {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                if (!plugged
                    ...
                    if (bucket != oldBucket || oldPlugged) {
                        Xlog.d(TAG, "playLowBatterySprivate RelativeLayout  mRelativeLayout;ound1");
                        playLowBatterySound();
                    }
    ...
    void showLowBatteryWarning() {
        ...
        if (mBatteryLevelTextView != null) {
            ...
            mRelativeLayout = (RelativeLayout) v.findViewById(R.id.padding);
		mRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            AlertDialog.Builder b = new AlertDialog.Builder(mContext,R.style.Dialog_Fullscreen);
