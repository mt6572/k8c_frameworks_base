...
public class NetworkTimeUpdateService {
    ...
    private BroadcastReceiver mConnectivityReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
			//Log.d("fuhaifa_connect", "====mConnectivityReceiver==action:"+action);
            if (ConnectivityManager.CONNECTIVITY_ACTION.equals(action)) {
                // There is connectivity
                final ConnectivityManager connManager = (ConnectivityManager) context
                        .getSystemService(Context.CONNECTIVITY_SERVICE);
                final NetworkInfo netInfo = connManager.getActiveNetworkInfo();
				//Log.d("fuhaifa_connect", "====Head====");
                if (netInfo != null) {
                    ...
                    if (netInfo.getState() == NetworkInfo.State.CONNECTED &&
						...
						//Log.d("fuhaifa_connect", "==X1=wifi connect success==type:"+netInfo.getType()+"==state:"+netInfo.getState());
                    }
                    ...
                    if (mIsOverMobile && netInfo.getState() == NetworkInfo.State.CONNECTED &&
                        ...
                        mHandler.obtainMessage(EVENT_NETWORK_CONNECTED).sendToTarget();
						//Log.d("fuhaifa_connect", "==X2=mobile data connect success==mIsOverMobile:"+mIsOverMobile+"==type:"+netInfo.getType()
							//+"==state:"+netInfo.getState());
                    }
                    ///@}
					//Log.d("fuhaifa_connect", "==X3=other connect==mIsOverMobile:"+mIsOverMobile+"==type:"+netInfo.getType()
							//+"==state:"+netInfo.getState());
                }
				//Log.d("fuhaifa_connect", "====End====");
            }
        }
    };
