...
public final class ShutdownThread extends Thread {
    ...
    //HEYONG NO VIB
    private static final int SHUTDOWN_VIBRATE_MS =500; //0;//500;
    ...
    private static int screen_turn_off_time = 6 * 1000;   //after 5sec  the screen become OFF, you can change the time delay
    ...
    private static void beginShutdownSequence(Context context) {
        ...
        int screenTurnOffTime = screen_turn_off_time;//mIBootAnim.getScreenTurnOffTime();
